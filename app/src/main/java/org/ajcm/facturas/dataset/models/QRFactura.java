...
public class QRFactura implements ModelAbstract{
    ...
    public QRFactura setData(Cursor cursor) {
        ...
        factura.setNombre_razon_social_comprador(cursor.getString(5));
        factura.setNombre_razon_social(cursor.getString(6));
        factura.setNit_ndi_ci(cursor.getString(7));
        factura.setNit(cursor.getString(8));
        factura.setImporte_ventas(cursor.getString(9));
        factura.setImporte_ice(cursor.getString(10));
        factura.setImporte_compra(cursor.getString(11));
